...
// Arduino IDE 2.2.1, ESP8266 3.1.2
...
#include "arduino_base64.hpp" // from library manager (https://github.com/dojyorin/arduino_base64)
...
void poll_lora() {
  if(receivedFlag) {
    ...
    char b64output[base64::encodeLength(length)];
    base64::encode(buf, length, b64output);
    doclora["data"] = b64output;
    byte loraID = buf[0];
    doclora["id"] = loraID;
