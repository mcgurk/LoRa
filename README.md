...
--- | --- | --- | --- | ---
MISO/SDO (SPI) ( $\colorbox{brown}{{\color{brown}{brown}}}$ ) | &leftarrow; | D6 (GPIO12) (SPI MISO) | GPIO19 (VSPI MISO) | IO12
MOSI/SDI (SPI) ( $\colorbox{orange}{{\color{orange}{orange}}}$ ) | &rightarrow; | D7 (GPIO13) (SPI MOSI) | GPIO23 (VSPI MOSI) | IO13
SCK/SCLK (SPI) ( $\colorbox{yellow}{{\color{yellow}{yellow}}}$ ) | &leftarrow; | D5 (GPIO14) (SPI SCLK) | GPIO18 (VSPI SCLK) | IO14
...
--- | --- | --- | ---
MISO/SDO (SPI) ( $\colorbox{brown}{{\color{brown}{brown}}}$ ) | &leftarrow; | D6 (GPIO12) (SPI MISO) | IO12
MOSI/SDI (SPI) ( $\colorbox{orange}{{\color{orange}{orange}}}$ ) | &rightarrow; | D7 (GPIO13) (SPI MOSI) | IO13
SCK/SCLK (SPI) ( $\colorbox{yellow}{{\color{yellow}{yellow}}}$ ) | &leftarrow; | D5 (GPIO14) (SPI SCLK) | IO14
NSS/SS/CS (SPI) ( $\colorbox{green}{{\color{green}{green}}}$ ) | &leftarrow; | D3 (GPIO0) | IO0
RESET ( $\colorbox{blue}{{\color{blue}{blue}}}$ ) | &leftarrow; | D4 (GPIO2) | IO2
DIO0 (IRQ) ( $\colorbox{gray}{{\color{gray}{gray}}}$ ) | &rightarrow; | D8 (GPIO15) | IO15
GND ( $\colorbox{black}{{\color{black}{black}}}$ ) | | G | GND
3.3V ( $\colorbox{red}{{\color{red}{red}}}$ ) | | 3V3 | 3.3V
ANA/ANT | | Antenna (86mm)
